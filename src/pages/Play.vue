<template>
  ...
  <div id="main">
    ...
    <div id="Bar">
      ...
      <h2 id="title">GeoTest.io</h2>
      <div id="score">
      <h2>{{ score }} / 195</h2>
      </div>

      <router-link id="homeBtn" to="/" @click="location.reload()">Home</router-link>
    </div>
  
  
    <div class="Modal" id="Modal">
      <button style="float: right" @click="closeModal()">X</button>
      <h5>Enter the name of the selected country:</h5>
      <br />
      <input id='input' type="text" />
      <button style="margin-left:8px" @click="checkInput()">Enter</button>
    </div>
    ...
    <div class="Zoom_outer">
      <div id="zoom">
        ...
        >
          <g class="Afghanistan" @click="openModal('AF', 'id')">
            <path
          ...
          <g class="Angola" @click="openModal('Angola', 'group')">
            <path
              class="Angola"
          ...
          <g class="Albania" @click="openModal('AL', 'id')">
            <path
          ...
          <g class="United Arab Emirates" @click="openModal('AE', 'id')">
            <path
          ...
          <g class="Argentina" @click="openModal('Argentina', 'group')">
            <path
              class="Argentina"
          ...
          <g class="Armenia" @click="openModal('AM', 'id')">
            <path
          ...
          <g class="Australia" @click="openModal('Australia', 'group')">
            <path
              class="Australia"
          ...
          <g class="Austria" @click="openModal('AT', 'id')">
            <path
          ...
          <g @click="openModal('Azerbaijan', 'group')">
            <path
              class="Azerbaijan"
          ...
          <g class="Burundi" @click="openModal('BI', 'id')">
            <path
          ...
          <g class="Belgium" @click="openModal('BE', 'id')">
            <path
          ...
          <g class="Benin" @click="openModal('BJ', 'id')">
            <path
          ...
          <g class="Burkina Faso" @click="openModal('BF', 'id')">
            <path
          ...
          <g class="Bangladesh" @click="openModal('BD', 'id')">
            <path
          ...
          <g class="Bulgaria" @click="openModal('BG', 'id')">
            <path
          ...
          <g class="Bosnia and Herzegovina" @click="openModal('BA', 'id')">
            <path
          ...
          <g class="Belarus" @click="openModal('BY', 'id')">
            <path
          ...
          <g class="Belize" @click="openModal('BZ', 'id')">
            <path
          ...
          <g class="Bolivia" @click="openModal('BO', 'id')">
            <path
          ...
          <g class="Brazil" @click="openModal('BR', 'id')">
            <path
          ...
          <g class="Brunei Darussalam" @click="openModal('BN', 'id')">
            <path
          ...
          <g class="Bhutan" @click="openModal('BT', 'ID')">
            <path
          ...
          <g class="Botswana" @click="openModal('BW', 'ID')">
            <path
          ...
          <g class="Central African Republic" @click="openModal('CF', 'ID')">
            <path
          ...
          <g @click="openModal('Canada', 'group')">
            <path
              class="Canada"
          ...
          <g class="Switzerland" @click="openModal('CH', 'ID')">
            <path
          ...
          <g class="China" @click="openModal('China', 'group')">
            <path
            class="China"
          ...
          <g class="Cote d'Ivoire" @click="openModal('CI', 'ID')">
            <path
          ...
          <g class="Cameroon" @click="openModal('CM', 'ID')">
            <path
          ...
          <g class="Democratic Republic of the Congo" @click="openModal('CD', 'ID')">
            <path
          ...
          <g class="Republic of Congo" @click="openModal('CG', 'ID')">
            <path
          ...
          <g class="Columbia" @click="openModal('CO', 'ID')">
            <path
          ...
          <g class="Costa Rica" @click="openModal('CR', 'ID')">
            <path
          ...
          <g class="Cuba" @click="openModal('CU', 'ID')">
            <path
          ...
          <g class="Czech Republic" @click="openModal('CZ', 'ID')">
            <path
          ...
          <g class="Germany" @click="openModal('DE', 'ID')">
            <path
          ...
          <g class="Dijibouti" @click="openModal('DJ', 'ID')">
            <path
          ...
          <g class="Denmark" @click="openModal('Denmark', 'group')">
            <path
            class="Denmark"
          ...
          <g class="Dominican Republic" @click="openModal('DO', 'ID')">
            <path
          ...
          <g class="Algeria" @click="openModal('DZ', 'ID')">
            <path
          ...
          <g class="Ecuador" @click="openModal('EC', 'ID')">
            <path
          ...
          <g class="Egypt" @click="openModal('EG', 'ID')">
            <path
          ...
          <g class="Eritrea" @click="openModal('ER', 'ID')">
            <path
          ...
          <g class="Estonia" @click="openModal('EE', 'ID')">
            <path
          ...
          <g class="Ethiopia" @click="openModal('ET', 'ID')">
            <path
          ...
          <g class="Finland" @click="openModal('FI', 'ID')">
            <path
          ...
          <g class="Gabon" @click="openModal('GA', 'ID')">
            <path
          ...
          <g class="United Kingdom" @click="openModal()">
            <path
          ...
          <g class="Georgia" @click="openModal('GE', 'ID')">
            <path
          ...
          <g class="Ghana" @click="openModal('GH', 'ID')">
            <path
          ...
          <g class="Guinea" @click="openModal('GN', 'ID')">
            <path
          ...
          <g class="The Gambia" @click="openModal('GM', 'ID')">
            <path
          ...
          <g class="Guinea-Bissau" @click="openModal('GW', 'ID')">
            <path
          ...
          <g class="Equatorial Guinea" @click="openModal('GQ', 'ID')">
            <path
          ...
          <g class="Greece" @click="openModal('Greece','group')">
            <path
              class="Greece"
          ...
          <g class="Greenland" @click="openModal('GL', 'ID')">
            <path
          ...
          <g class="Guatemala" @click="openModal('GT', 'ID')">
            <path
          ...
          <g class="Guyana" @click="openModal('GY', 'ID')">
            <path
          ...
          <g class="Honduras" @click="openModal('HN', 'ID')">
            <path
          ...
          <g class="Croatia" @click="openModal('HR', 'ID')">
            <path
          ...
          <g class="Haiti" @click="openModal('HT', 'ID')">
            <path
          ...
          <g class="Hungary" @click="openModal('HU', 'ID')">
            <path
          ...
          <g class="Indonesia" @click="openModal()">
            <path
          ...
          <g class="India" @click="openModal('IN', 'ID')">
            <path
          ...
          <g class="Ireland" @click="openModal('IE', 'ID')">
            <path
          ...
          <g class="Iran" @click="openModal('IR', 'ID')">
            <path
          ...
          <g class="Iraq" @click="openModal('IQ', 'ID')">
            <path
          ...
          <g class="Iceland" @click="openModal('IS', 'ID')">
            <path
          ...
          <g class="Israel" @click="openModal('IL', 'ID')">
            <path
          ...
          <g class="Italy" @click="openModal('Italy', 'group')">
            <path
            class="Italy"
          ...
          <g class="Jamaica" @click="openModal('JM', 'ID')">
            <path
          ...
          <g class="Jordan" @click="openModal('JO', 'ID')">
            <path
          ...
          <g class="Japan" @click="openModal('Japan', 'group')">
            <path
            class="Japan"
          ...
          <g class="Kazakhstan" @click="openModal('KZ', 'ID')">
            <path
          ...
          <g class="Kenya" @click="openModal('KE', 'ID')">
            <path
          ...
          <g class="Krygyzstan" @click="openModal('KG', 'ID')">
            <path
          ...
          <g class="Cambodia" @click="openModal('KH', 'ID')">
            <path
          ...
          <g class="Republic of Korea" @click="openModal('KR', 'ID')">
            <path
          ...
          <g class="Kuwait" @click="openModal('KW', 'ID')">
            <path
          ...
          <g class="Lao PDR" @click="openModal('LA', 'ID')">
            <path
          ...
          <g class="Lebanon" @click="openModal('LB', 'ID')">
            <path
          ...
          <g class="Liberia" @click="openModal('LR', 'ID')">
            <path
          ...
          <g class="Libya" @click="openModal('LY', 'ID')">
            <path
          ...
          <g class="Sri Lanka" @click="openModal('LK', 'ID')">
            <path
          ...
          <g class="Lesotho" @click="openModal('LS', 'ID')">
            <path
          ...
          <g class="Lithuania" @click="openModal('LT', 'ID')">
            <path
          ...
          <g class="Luxembourg" @click="openModal('LU', 'ID')">
            <path
          ...
          <g class="Latvia" @click="openModal('LV', 'ID')">
            <path
          ...
          <g class="Morocco" @click="openModal('MA', 'ID')">
            <path
          ...
          <g class="Moldova" @click="openModal('MD', 'ID')">
            <path
          ...
          <g class="Madagascar" @click="openModal('MG', 'ID')">
            <path
          ...
          <g class="Mexico" @click="openModal('MX', 'ID')">
            <path
          ...
          <g class="Macedonia" @click="openModal('MK', 'ID')">
            <path
          ...
          <g class="Mali" @click="openModal('ML', 'ID')">
            <path
          ...
          <g class="Myanmar" @click="openModal('MM', 'ID')">
            <path
          ...
          <g class="Montenegro" @click="openModal('ME', 'ID')">
            <path
          ...
          <g class="Mongolia" @click="openModal('MN', 'ID')">
            <path
          ...
          <g class="Mozambique" @click="openModal('MZ', 'ID')">
            <path
          ...
          <g class="Mauritania" @click="openModal('MR', 'ID')">
            <path
          ...
          <g class="Malawi" @click="openModal('MW', 'ID')">
            <path
          ...
          <g class="Malaysia" @click="openModal('Malaysia', 'group')">
            <path
              class="Malaysia"
          ...
          <g class="Namibia" @click="openModal('NA', 'ID')">
            <path
          ...
          <g class="Niger" @click="openModal('NE', 'ID')">
            <path
          ...
          <g class="Nigeria" @click="openModal('NG', 'ID')">
            <path
          ...
          <g class="Nicaragua" @click="openModal('NI', 'ID')">
            <path
          ...
          <g class="Norway" @click="openModal('Norway', 'group')">
            <path
              class="Norway"
          ...
          <g class="Nepal" @click="openModal('NP', 'ID')">
            <path
          ...
          <g class="Oman" @click="openModal('Oman', 'group')">
            <path
              class="Oman"
          ...
          <g class="Pakistan" @click="openModal('PK', 'ID')">
            <path
          ...
          <g class="Panama" @click="openModal('PA', 'ID')">
            <path
          ...
          <g class="Peru" @click="openModal('PE', 'ID')">
            <path
          ...
          <g class="Philippines" @click="openModal('Philippines', 'group')">
            <path
              class="Philippines"
          ...
          <g class="Papua New Guinea" @click="openModal('Papa New Guinea', 'group')">
            <path
          ...
          <g class="Poland" @click="openModal('PL', 'ID')">
            <path
          ...
          <g class="Dem. Rep. Korea" @click="openModal('KP', 'ID')">
            <path
          ...
          <g class="Paraguay" @click="openModal('PY', 'ID')"> 
            <path
          ...
          <g class="Palestine" @click="openModal('PS', 'ID')">
            <path
          ...
          <g class="Qatar" @click="openModal('QA', 'ID')">
            <path
          ...
          <g class="Romania" @click="openModal('RO', 'ID')">
            <path
          ...
          <g class="Rwanda" @click="openModal('RW', 'ID')">
            <path
          ...
          <g class="Western Sahara" @click="openModal('EH', 'ID')">
            <path
          ...
          <g class="Saudi Arabia" @click="openModal('SA', 'ID')">
            <path
          ...
          <g class="Sudan" @click="openModal('SD', 'ID')">
            <path
          ...
          <g class="South Sudan" @click="openModal('SS', 'ID')">
            <path
          ...
          <g class="Senegal" @click="openModal('SN', 'ID')">
            <path
          ...
          <g class="Sierra Leone" @click="openModal('SL', 'ID')">
            <path
          ...
          <g class="El Salvador" @click="openModal('SV', 'ID')">
            <path
          ...
          <g class="Serbia" @click="openModal('RS', 'ID')">
            <path
          ...
          <g class="Suriname" @click="openModal('SR', 'ID')">
            <path
          ...
          <g class="Slovakia" @click="openModal('SK', 'ID')">
            <path
          ...
          <g class="Slovenia" @click="openModal('SI', 'ID')">
            <path
          ...
          <g class="Sweden" @click="openModal('SE', 'ID')">
            <path
          ...
          <g class="Eswatini" @click="openModal('SZ', 'ID')">
            <path
          ...
          <g class="Syria" @click="openModal('SY', 'ID')">
            <path
          ...
          <g class="Chad" @click="openModal('TD', 'ID')">
            <path
          ...
          <g class="Togo" @click="openModal('TG', 'ID')">
            <path
          ...
          <g class="Thailand" @click="openModal('TH', 'ID')"> 
            <path
          ...
          <g class="Tajikistan" @click="openModal('TJ', 'ID')">
            <path
          ...
          <g class="Turkmenistan" @click="openModal('TM', 'ID')">
            <path
          ...
          <g class="Timor-Lest" @click="openModal('TL', 'ID')">
            <path
          ...
          <g class="Tunisia" @click="openModal('TN', 'ID')">
            <path
          ...
          <g class="Turkey" @click="openModal('Turkey', 'group')">
            <path
              class="Turkey"
          ...
          <g class="Taiwan" @click="openModal('TW', 'ID')">
            <path
          ...
          <g class="Tanzania" @click="openModal('TZ', 'ID')">
            <path
          ...
          <g class="Uganda" @click="openModal('UG', 'ID')">
            <path
          ...
          <g class="Ukraine" @click="openModal('UA', 'ID')"> 
            <path
          ...
          <g class="Uruguay" @click="openModal('UY', 'ID')">
            <path
          ...
          <g class="Uzbekistan" @click="openModal('UZ', 'ID')"> 
            <path
          ...
          <g class="Venezuela" @click="openModal('VE', 'ID')">
            <path
          ...
          <g class="Vietnam" @click="openModal('VN', 'ID')">
            <path
          ...
          <g class="Yemen" @click="openModal('YE', 'ID')">
            <path
          ...
          <g class="Zambia" @click="openModal('ZM', 'ID')">
            <path
          ...
          <g class="Zimbabwe" @click="openModal('ZW', 'ID')">
            <path
          ...
          <g class="Somalia" @click="openModal('SO', 'ID')">
            <path
          ...
          <g class="Kosovo" @click="openModal('XK', 'ID')">
            <path
          ...
          <g class="South Africa" @click="openModal('ZA', 'ID')">
            <path
          ...
          <g class="New Zealand" @click="openModal('New Zealand', 'group')">
            <path
              class="New Zealand"
          ...
          <g class="Chile" @click="openModal('Chile', 'group')">
            <path
              class="Chile"
          ...
          <g class="Netherlands" @click="openModal('NL', 'ID')">
            <path
          ...
          <g class="Portugal"  @click="openModal('PT', 'ID')">
            <path
          ...
          <g class="Russian Federation" @click="openModal('Russian Federation', 'group')">
            <path
          ...
          <g class="Spain" @click="openModal('ES', 'ID')">
            <path
          ...
          <g class="France" @click="openModal('France', 'group')">
            <path
              class="France"
          ...
          <g @click="openModal('United States', 'group')">
            <path
              class="United States"
          ...
          <g class="French Guiana" @click="openModal('GF', 'ID')">
            <path
          ...
          <g class="Aruba" @click="openModal('AW', 'ID')">
            <path
          ...
          <g class="Anguilla" @click="openModal('AI', 'ID')">
            <path
          ...
          <g class="American Samoa" @click="openModal('American Samoa', 'group')">
            <path
          ...
          <g class="Antigua and Barbuda" @click="openModal('Antigua and Barbuda', 'group')">
            <path
          ...
          <g class="Bahrain" @click="openModal('BH', 'ID')">
            <path
          ...
          <g class="Bahamas" @click="openModal('Bahamas', 'group')">
            <path
              class="Bahamas"
          ...
          <g class="Saint-Barthélemy" @click="openModal('BL', 'ID')">
            <path
          ...
          <g class="Bermuda" @click="openModal('BM', 'ID')">
            <path
          ...
          <g class="Barbados" @click="openModal('BB', 'ID')">
            <path
          ...
          <g class="Comoros" @click="openModal('Comoros', 'group')">
            <path
              class="Comoros"
          ...
          <g class="Cape Verde" @click="openModal('Cape Verde', 'group')">
            <path
              class="Cape Verde"
          ...
          <g class="Curaçao" @click="openModal('CW', 'ID')">
            <path
          ...
          <g class="Cayman Islands" @click="openModal('Cayman Islands', 'group')">
            <path
          ...
          <g class="Cyprus" @click="openModal('Cyprus', 'group')">
            <path
              class="Cyprus"
          ...
          <g class="Dominica" @click="openModal('DM', 'ID')">
            <path
          ...
          <g class="Falkland Islands" @click="openModal('Falkland Islands', 'group')">
            <path
          ...
          <g class="Faeroe Islands" @click="openModal('Faeroe Islands', 'group')">
            <path
          ...
          <g class="Federated States of Micronesia" @click="openModal('Federated States of Micronesia', 'group')">
            <path
          ...
          <g class="Grenada" @click="openModal('GD', 'ID')">
            <path
          ...
          <g class="Guam" @click="openModal('GU', 'ID')">
            <path
          ...
          <g class="Saint Kitts and Nevis" @click="openModal('Saint Kitts and Nevis', 'group')">
            <path
          ...
          <g class="Saint Lucia" @click="openModal('LC', 'ID')">
            <path
          ...
          <g class="Saint-Martin" @click="openModal('MF', 'ID')">
            <path
          ...
          <g class="Maldives" @click="openModal('MV', 'ID')">
            <path
          ...
          <g class="Marshall Islands" @click="openModal('MH', 'ID')">
            <path
          ...
          <g class="Malta"  @click="openModal('Malta', 'group')">
            <path
              class="Malta"
          ...
          <g class="Northern Mariana Islands"  @click="openModal('Northern Mariana Islands', 'group')">
            <path
          ...
          <g class="Montserrat" @click="openModal('MS', 'ID')">
            <path
          ...
          <g class="Mauritius" @click="openModal('Mauritius', 'group')">
            <path
              class="Mauritius"
          ...
          <g class="New Caledonia" @click="openModal('New Caledonia', 'group')">
            <path
              class="New Caledonia"
          ...
          <g class="Nauru" @click="openModal('NR', 'ID')">
            <path
          ...
          <g class="Palau" @click="openModal('PW', 'ID')">
            <path
          ...
          <g class="Puerto Rico" @click="openModal('Puerto Rico', 'group')">
            <path
              class="Puerto Rico"
          ...
          <g class="French Polynesia" @click="openModal('French Polynesia', 'group')">
            <path
          ...
          <g class="Solomon Islands" @click="openModal('Solomon Islands', 'group')">
            <path
          ...
          <g class="São Tomé and Principe" @click="openModal('São Tomé and Principe', 'group')">
            <path
          ...
          <g class="Sint Maarten" @click="openModal('SX', 'ID')">
            <path
          ...
          <g class="Seychelles" @click="openModal('Seychelles', 'group')">
            <path
              class="Seychelles"
          ...
          <g class="Turks and Caicos Islands" @click="openModal('Turks and Caicos Islands', 'group')">
            <path
          ...
          <g class="Tonga" @click="openModal('Tonga', 'group')">
            <path
              class="Tonga"
          ...
          <g class="Trinidad and Tobago" @click="openModal('Trinidad and Tobago', 'group')">
            <path
          ...
          <g class="Tuvalu" @click="openModal('Tuvalu', 'ID')">
            <path
          ...
          <g class="Saint Vincent and the Grenadines" @click="openModal('VC', 'ID')">
            <path
          ...
          <g class="British Virgin Islands" @click="openModal('VG', 'ID')">
            <path
          ...
          <g class="United States Virgin Islands" @click="openModal('United States Virgin Islands', 'group')">
            <path
          ...
          <g class="Vanuatu" @click="openModal('Vanuatu', 'group')">
            <path
              class="Vanuatu"
          ...
          <g class="Samoa"  @click="openModal('Samoa', 'group')">
            <path
              class="Samoa"
          ...
          <g class="Netherlands" @click="openModal('BQBO', 'ID')">
            <path
          ...
          <g class="St. Eustatius" @click="openModal('BQSE', 'ID')">
            <path
          ...
          <g class="Saba" @click="openModal('BQSA', 'ID')">
            <path
          ...
          <g class="Martinique" @click="openModal('MQ', 'ID')">
            <path
          ...
          <g class="Canary Islands" @click="openModal('Canary Islands', 'group')">
            <path
          ...
          <g class="Mayotte" @click="openModal('YT', 'ID')">
            <path
          ...
          <g class="Reunion" @click="openModal('RE', 'ID')">
            <path
          ...
          <g class="Guadeloupe" @click="openModal('Guadeloupe', 'group')">
            <path
              class="Guadeloupe"
          ...
          <g class="Fiji" @click="openModal('Fiji', 'group')">
            <path
              class="Fiji"
...
function openModal(country, type) {
  document.getElementById("Modal").style.display = "block";

  if(type=="id" || type=="ID"){
    document.getElementById(country).style.fill="black";
    selectedCountry=country;
    data = document.getElementById(country).attributes.name.nodeValue;
    console.log(data);
  }else{
    islands = document.getElementsByClassName(country);

    data = islands[0].className.baseVal;
    console.log(data);

    for(let i=0; i < islands.length; i++){
      islands[i].style.fill="black";
    }
  }
}
...
function closeModal() {
  ...
  if(islands){
    for(let i=0; i < islands.length; i++){
      islands[i].style.fill="";
    }
  islands = null;
  }else{
    document.getElementById(selectedCountry).style.fill="";
  }
...
function checkInput(){
  ...
  if(islands){
    answer = islands[0].className.baseVal;
    
  }else{
    answer = document.getElementById(selectedCountry).attributes.name.nodeValue;
  }
  ...
  if(input == answer){
    if(islands){
      for(let i=0; i < islands.length; i++){
        islands[i].style.fill="green";
      }
      islands = null;
    }else{
      document.getElementById(selectedCountry).style.fill="green";
      // document.getElementById(selectedCountry).style.pointerEvents="none";
    }
    ...
    console.log("SCORE: ", score);
      ...
      if(islands){
      for(let i=0; i < islands.length; i++){
        islands[i].style.fill="red";
      }
      islands = null;
      }else{
        document.getElementById(selectedCountry).style.fill="red";
        // document.getElementById(selectedCountry).style.pointerEvents="none";
      }
  }
